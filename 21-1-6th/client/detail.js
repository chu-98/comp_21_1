...
async function getPostDetail() {
    try {
        ...
        if (post === undefined) { //만약 게시글 정보를 불러올 수 없는 경우, 예를 들면 삭제된 게시글을 요청하는 경우
        ...
        //innerHTML을 쓰는 이유는 스터디에서 설명! 어쨌든 태그 안에 내용을 넣는 것은 textContent와 유사!
...
document.querySelector("#delete").addEventListener("click", async () => {
    //confirm함수는 확인, 취소(예, 아니오)가 가능한 창이 뜸. 확인 누르면 true, 취소 누르면 false가 됨.
